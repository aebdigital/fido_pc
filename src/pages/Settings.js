  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-200 dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <button className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white px-6 py-2 rounded-2xl font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-sm hover:shadow-md">
                {t('Try Pro')}
              </button>
            </div>
          </div>
